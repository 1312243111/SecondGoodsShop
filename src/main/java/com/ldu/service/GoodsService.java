...
public interface GoodsService {
     ...
     * 通过最新发布分类获取商品信息
     */
    List<Goods> getGoodByStr(Integer limit,String name,String describle);
   ...
   public int addGoods(Goods goods, Integer duration);
     ...
     * @return
     */
    public Goods getGoodsByPrimaryKey(Integer goodsId);//更新
    /**
     * 通过主键删除商品
     * @param id
     */
   ...
   public void deleteGoodsByPrimaryKeys(Integer id);//后台删除
    /**
     * 模糊查询
     * @param id
     * @param name
  ...
  //  void updateGoodsByPrimaryKeyWithBLOBs(Integer id, Goods goods);
}